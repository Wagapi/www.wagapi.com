            ...
            <ul class="nav">
              ...
              <li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li class="">
						<a href="./simplecloud.php">SimpleCloud</a>
					</li>	
					<li class="">
						<a href="http://smartsha.re">SmartShare</a>
					</li>					
				  </ul>
              </li>
              <li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					...
					<li class="">
						<a href="./api.php">Developer API</a>
					</li>	
					<li class="">
						<a href="#">Git</a>
					</li>					
              ...
              <li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li class="">
						<a href="https://wagapi.zendesk.com/home">Support</a>
					</li>
					<li class="">
						<a href="https://wagapi.zendesk.com/forums">Forums</a>
					</li>
					<li class="">
...
?>
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">
							Logged in as <?php	echo($session->agent->get_login()) ?>
							<span class="caret"></span>
						</a>
				  <ul class="dropdown-menu">
					<li class="">
					...
					<div class="dropdown-menu" style="padding: 15px; padding-bottom: 0px;">
					  <!-- Login form here -->
						...
						<label class="string optional" for="user_remember_me"> Remember me</label>
						 <a href="lost_password.php">Lost your password ? Click here</a>
