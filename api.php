...
<div class="container" style="text-align:justify">
	...
	<div class="main-text">
		...
		<p>
		Using the API requires a key for access to the API, which will be called api_key or simply <span class="variable">key</span> in the following lines. You can generate your unique key
		through the settings panel of your wagapi account (accessible from the top of this page). To access a specific account, user name and password of the account are also required for the application to authenticate.
		</p>
		<h3>
			General concepts
		</h3>
...
fclose($fp); 			
			...
			<section id="/list/docs/from/path">
...
$('#somedocslist').on('click', function(event){
	...
	$.ajax({
		...
		success: function(data){
			...
			<section id="/list/tags/from/path">
